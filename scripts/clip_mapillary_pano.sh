...
sphericaldocker="docker run -v $PWD:/mnt/ -v $HOME/.aws:/root/.aws --rm -e MAPILLARY_ACCESS_TOKEN=$MAPILLARY_ACCESS_TOKEN -e AWS_PROFILE=xxxxx -it developmentseed/spherical2images:v1"
